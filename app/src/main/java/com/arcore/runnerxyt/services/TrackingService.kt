package com.arcore.runnerxyt.services
...
import com.arcore.runnerxyt.other.Constants
import com.arcore.runnerxyt.other.Constants.Companion.ACTION_PAUSE_SERVICE
import com.arcore.runnerxyt.other.Constants.Companion.ACTION_START_OR_RESUME_SERVICE
import com.arcore.runnerxyt.other.Constants.Companion.ACTION_STOP_SERVICE
import com.arcore.runnerxyt.other.Constants.Companion.FASTEST_LOCATION_UPDATE_INTERVAL
import com.arcore.runnerxyt.other.Constants.Companion.LOCATION_UPDATE_INTERVAL
import com.arcore.runnerxyt.other.Constants.Companion.NOTIFICATION_CHANNEL_ID
import com.arcore.runnerxyt.other.Constants.Companion.NOTIFICATION_CHANNEL_NAME
import com.arcore.runnerxyt.other.Constants.Companion.NOTIFICATION_ID
...
class TrackingService : LifecycleService() {
    ...
    private fun updateLocationChecking(isTracking: Boolean) {
        if (isTracking) {
            if (TrackingUtility.checkAndRequestPermissions(this,permissions)) {
    ...
    private fun startForegroundService() {
        Timber.d("com.androiddevs.runningapp.services.TrackingService started.")
